...
dependencies {
    testImplementation(project(":blue-hive-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../blue-hive-java-core/src/main/resources/META-INF/proguard/blue-hive-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.bluehive.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../blue-hive-java-core/src/main/resources/META-INF/proguard/blue-hive-java-core.pro",
