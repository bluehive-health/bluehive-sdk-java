...
[![Maven Central](https://img.shields.io/maven-central/v/com.bluehive.api/blue-hive-java)](https://central.sonatype.com/artifact/com.bluehive.api/blue-hive-java/0.0.1-alpha.0)
[![javadoc](https://javadoc.io/badge2/com.bluehive.api/blue-hive-java/0.0.1-alpha.0/javadoc.svg)](https://javadoc.io/doc/com.bluehive.api/blue-hive-java/0.0.1-alpha.0)
...
The REST API documentation can be found on [docs.bluehive.com](https://docs.bluehive.com/). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.bluehive.api/blue-hive-java/0.0.1-alpha.0).
...
```kotlin
implementation("com.bluehive.api:blue-hive-java:0.0.1-alpha.0")
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/bluehive-java/issues) with questions, bugs, or suggestions.
