...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): VersionRetrieveParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is VersionRetrieveParams && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
