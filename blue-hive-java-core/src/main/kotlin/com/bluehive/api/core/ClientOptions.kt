...
import com.bluehive.api.core.http.PhantomReachableClosingHttpClient
import com.bluehive.api.core.http.QueryParams
import com.bluehive.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `blue-hive-java-client-okhttp` or implement your own.
     */
     ...
     *
     * Defaults to [com.bluehive.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://api.bluehive.com"
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("bluehive.baseUrl") ?: System.getenv("BLUE_HIVE_BASE_URL"))?.let {
                baseUrl(it)
            }
            (System.getProperty("bluehive.apiKey") ?: System.getenv("BLUEHIVE_API_KEY"))?.let {
                apiKey(it)
            }
        }
