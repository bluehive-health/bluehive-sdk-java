...
import com.bluehive.api.core.MultipartField
    ...
    object : HttpRequestBody {
        ...
        private fun serializePart(
            ...
            when (node.nodeType) {
                            ...
                            node
                                ...
                                .mapNotNull { element ->
                                    when (element.nodeType) {
                                        ...
                                        JsonNodeType.OBJECT,
                                        JsonNodeType.POJO ->
                                            throw BlueHiveInvalidDataException(
                ...
                JsonNodeType.POJO,
                null ->
                    throw BlueHiveInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
            }
