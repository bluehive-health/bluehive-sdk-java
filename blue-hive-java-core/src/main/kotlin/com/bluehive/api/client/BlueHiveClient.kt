...
/**
 * A client for interacting with the BlueHive REST API synchronously. You can also switch to
...
interface BlueHiveClient {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): BlueHiveClient
    ...
    /** A view of [BlueHiveClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): BlueHiveClient.WithRawResponse
        ...
        fun fax(): FaxService.WithRawResponse
    }
}
