...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.bluehive.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.bluehive.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.bluehive.api.** {
    <init>(...);
