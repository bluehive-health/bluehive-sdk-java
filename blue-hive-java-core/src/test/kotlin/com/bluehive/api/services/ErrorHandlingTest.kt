...
package com.bluehive.api.services
...
internal class ErrorHandlingTest {
    ...
    private lateinit var client: BlueHiveClient
    ...
    fun healthCheck400() {
        ...
        val e = assertThrows<BadRequestException> { healthService.check() }
    ...
    fun healthCheck401() {
        ...
        val e = assertThrows<UnauthorizedException> { healthService.check() }
    ...
    fun healthCheck403() {
        ...
        val e = assertThrows<PermissionDeniedException> { healthService.check() }
    ...
    fun healthCheck404() {
        ...
        val e = assertThrows<NotFoundException> { healthService.check() }
    ...
    fun healthCheck422() {
        ...
        val e = assertThrows<UnprocessableEntityException> { healthService.check() }
    ...
    fun healthCheck429() {
        ...
        val e = assertThrows<RateLimitException> { healthService.check() }
    ...
    fun healthCheck500() {
        ...
        val e = assertThrows<InternalServerException> { healthService.check() }
    ...
    fun healthCheck999() {
        ...
        val e = assertThrows<UnexpectedStatusCodeException> { healthService.check() }
    ...
    fun healthCheckInvalidJsonBody() {
        ...
        val e = assertThrows<BlueHiveException> { healthService.check() }
