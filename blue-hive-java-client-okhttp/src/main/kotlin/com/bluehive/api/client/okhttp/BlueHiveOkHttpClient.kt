...
import com.bluehive.api.client.BlueHiveClientImpl
...
/**
 * A class that allows building an instance of [BlueHiveClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class BlueHiveOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [BlueHiveClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): BlueHiveClient = builder().fromEnv().build()
    }

    /** A builder for [BlueHiveOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BlueHiveClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BlueHiveClient =
            BlueHiveClientImpl(
                clientOptions
                    .httpClient(
